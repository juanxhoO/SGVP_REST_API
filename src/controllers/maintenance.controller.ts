...
const getMaintenance = catchAsync(async (req, res) => {
  ...
  const user = await maintenanceService.getMaintenanceById(req.params.maintenanceId);
...
const updateMaintenance = catchAsync(async (req, res) => {
  const user = await maintenanceService.updateMaintenanceById(req.params.maintenanceId, req.body);
  res.send(user);
});

const deleteMaintenance = catchAsync(async (req, res) => {
  await maintenanceService.deleteMaintenanceById(req.params.maintenanceId);
